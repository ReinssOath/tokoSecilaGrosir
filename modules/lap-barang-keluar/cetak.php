...
if (isset($_GET['tgl_awal'])) {
    ...
    $query = mysqli_query($mysqli, "SELECT a.kode_transaksi,a.tanggal_keluar,a.kode_barang,a.jumlah_keluar,b.kode_barang,b.nama_barang,b.satuan
                                    FROM barang_keluar as a INNER JOIN tb_barang as b ON a.kode_barang=b.kode_barang
                                    WHERE $qr_jenis a.tanggal_keluar BETWEEN '$tgl_awal' AND '$tgl_akhir'
...
<html xmlns="http://www.w3.org/1999/xhtml"> <!-- Bagian halaman HTML yang akan konvert -->
    <head>
        ...
        <title>Laporan Barang Keluar | Toko Secila</title>
    ...
    // jika data tidak ada
        ...
        while ($data = mysqli_fetch_assoc($query)) {
            ...
            echo "  <tr>
                        ...
                        <td width='100' height='13' align='right' valign='middle'>$data[jumlah_keluar]</td>
