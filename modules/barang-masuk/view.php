      ...
      <div class="box box-primary">
        <div class="box-body  table-responsive">
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            $query = mysqli_query($mysqli, "SELECT a.kode_transaksi,a.tanggal_masuk,a.kode_barang,a.jumlah_masuk,b.kode_barang,b.nama_barang,b.satuan,a.asal
                                            FROM barang_masuk as a INNER JOIN tb_barang as b ON a.kode_barang=b.kode_barang ORDER BY kode_transaksi DESC")
            ...
            while ($data = mysqli_fetch_assoc($query)) { 
              ...
              echo "<tr>
                      ...
                      <td width='80' class='left'>$data[asal]</td>
                    </tr>";
              $no++;
            }
            ?>
