          ...
          <form role="form" class="form-horizontal" action="modules/barang-masuk/proses.php?act=insert" method="POST" name="formBarangMasuk">
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input list="asal_barang" class="form-control chosen" id="asal" name="asal" autocomplete="off" required>
                  <datalist id="asal_barang">
                    <?php
                      $query_asal = mysqli_query($mysqli, "SELECT asal FROM v_barang_asal ORDER BY asal ASC")
                                                            or die('Ada kesalahan pada query tampil barang: '.mysqli_error($mysqli));
                      while ($data_asal = mysqli_fetch_assoc($query_asal)) {
                        echo"<option> $data_asal[asal] </option>";
                      }
                    ?>
                  </datalist>
                </div>
