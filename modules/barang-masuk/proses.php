...
// jika user sudah login, maka jalankan perintah untuk insert, update, dan delete
    ...
    if ($_GET['act']=='insert') {
        if (isset($_POST['simpan'])) {
            ...
            $query = mysqli_query($mysqli, "INSERT INTO barang_masuk(kode_transaksi,tanggal_masuk,kode_barang,jumlah_masuk,stok,total_stok,asal,created_user) 
                                            VALUES('$kode_transaksi','$tanggal_masuk','$kode_barang','$jumlah_masuk','$stok','$total_stok','$asal','$created_user')")
