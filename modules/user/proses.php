	...
	hak_akses   = '$hak_akses'
				...
				elseif (empty($_POST['password']) && !empty($_FILES['foto']['name'])) {
					...
					if (in_array($extension, $allowed_extensions)) {
	                    ...
	                    if($ukuran_file <= $ukuran_boleh) { // Cek apakah ukuran file yang diupload kurang dari sama dengan 1MB
				...
				// jika password diubah dan foto diubah
					...
					if (in_array($extension, $allowed_extensions)) {
	                    // Jika tipe file yang diupload sesuai dengan allowed_extensions, lakukan :
	                    if($ukuran_file <= $ukuran_boleh) { // Cek apakah ukuran file yang diupload kurang dari sama dengan 5MB
