      ...
      <div class="box box-primary">
        <div class="box-body table-responsive">
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            $query = mysqli_query($mysqli, "SELECT a.kode_transaksi,a.tanggal_keluar,a.kode_barang,a.jumlah_keluar,b.kode_barang,b.nama_barang,b.satuan,a.tujuan
                                            FROM barang_keluar as a INNER JOIN tb_barang as b ON a.kode_barang=b.kode_barang ORDER BY kode_transaksi DESC")
            ...
            while ($data = mysqli_fetch_assoc($query)) { 
              ...
              echo "<tr>
                      ...
                      <td width='80' class='center'>$data[tujuan]</td>
                    </tr>";
              $no++;
            }
            ?>
